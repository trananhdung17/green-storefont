...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		...
		<div class="site-info">
			...
			<br /> <?php printf( esc_attr__( '%1$s designed by %2$s, product of Green.', 'green' ), 'This website', '<a href="http://www.green.com" title="GreenCommerce - The Best eCommerce Platform for You" rel="author">GreenCommerce</a>' ); ?>
			<?php } ?>
		</div><!-- .site-info -->
		<?php
	}
